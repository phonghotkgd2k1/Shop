...
class KhoNhap extends Model
{
    use HasFactory;
    public static function getAllProduct()
    {   
        $khonhap = DB::table('khonhap')
                    ->select('khonnhap.*', 'brand.name AS name_brand','admin.name AS name_admin', 'gb.name AS name_gb')
                    ...
                    ->join('gb', 'gb.id_gb', '=', 'product.id_gb')
    ...
    public static function createProduct($name,$datenhap,$name_admin, $images, $brand, $price, $discount, $quantity, $content, $description, $isactive)
    {
        try {
            $idProduct = null;
    ...
    public static function updateProduct($id_Product,$name,$datenhap,$name_admin, $images, $brand, $price, $discount, $quantity, $content, $description, $isactive)
    {    
        try {
            $id_Product = null;
            foreach ($images as $key => $value) {
