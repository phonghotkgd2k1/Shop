            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="dropdown nav-item">
                    <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                        <div class="photo">
                            <img src="{{asset('images/account.png')}}" alt="">{{SESSION::get('name')}}
                        </div>
                    ...
                    <ul class="dropdown-menu dropdown-navbar">
                        <li class="nav-link"><a href="javascript:void(0)" class="nav-item dropdown-item">{{SESSION::get('name')}}</a>
                        </li>
                        <li class="nav-link"><a href="javascript:void(0)" class="nav-item dropdown-item">Settings</a>
                        </li>
                        <li class="dropdown-divider"></li>
                        <li class="nav-link"><a href="{{ route('admin.logout') }}" class="nav-item dropdown-item">Log out</a>
                        </li>
                    </ul>
                </li>
